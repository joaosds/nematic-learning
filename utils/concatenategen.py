...
n2 = 11 + 1 # number of files + 1
n1 = 10
data_dict = {'data_'+str(i) : np.load(path + 'station{0}/temptest{0}.npz'.format(i)) for i in range(n1,n2)}
...
#np.savez('Testangle2.npz', DataX=arr_0, DataY=arr_1, DataZ=arr_2, DataW=arr_3, DataP=arr_4)
np.savez('Teststrainnew.npz', DataX=arr_0, DataY=arr_1, DataZ=arr_2, DataW=arr_3)
